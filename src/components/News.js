...
export class News extends Component {
  ...
  capitilizeFirstLetter = (string) => {
    // to capitilized first word of title
  ...
  //     //   })
  //     // }
  //     // this.setState({page: this.state.page+1});                // from this line .....used for updateNews() when we have next and  previous buttons.
  //     // this.updateNews();
  //   };
  ...
  fetchMoreData = async () => {
    ...
    let url = `https://newsapi.org/v2/top-headlines?country=${
      ...
      this.props.category
    }&apiKey=4c7bef50b632477698b5bbe4953277b6&page=${
      this.state.page + 1
    ...
    return (
      <div className="container my-3">
        <h2
          ...
          style={{ margin: "10px 0px", marginTop: "90px" }}
        >
          Top {this.capitilizeFirstLetter(this.props.category)} Headlines
        </h2>
