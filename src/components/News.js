...
export class News extends Component {
        ...
        async componentDidMount(){
            console.log("cdm");
            let url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=4c7bef50b632477698b5bbe4953277b6&page=1&pageSize=20";
           ...
           handleNextClick = async ()=>{
            ...
            let url = `https://newsapi.org/v2/top-headlines?country=in&apiKey=4c7bef50b632477698b5bbe4953277b6&page=${this.state.page+1}&pageSize=20`;
            let data = await fetch(url);
            let parsedData = await data.json();
              this.setState({
